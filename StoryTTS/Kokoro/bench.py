"""Concurrent HTTP benchmark for a running Kokoro-FastAPI server."""
    ...
    async with httpx.AsyncClient(timeout=args.timeout) as client:
        async def one() -> None:
            ...
            async with semaphore:
                ...
                except Exception as exc:  # report all failed jobs without hiding the total
                    errors += 1
...
def main() -> None:
    ...
    parser.add_argument("--base-url", default="http://127.0.0.1:2221/v1")
